...
class Player(object):
    def __init__(self, config):
        ...
        self.ensure_dir('model_weights')
        self.ensure_dir('reward_histories')
        self.ensure_dir('object_interaction_histories')
        self.ensure_dir('pickleFiles')
    ...
    def update_rendering(self):
        """Update the rendering window with the latest game state."""
